...
public class Roommate {
    ...
    private String Prefrerred_profession;

    public Roommate() {
    }

    public Roommate(String posted_as, String property_type, String room_price, String room_state,
                    String image_URL, String room_title, String posted_by, String posted_gender, String user_ID,
                    String document_ID, String contact, String preferred_gender, String prefrerred_profession) {
        Posted_as = posted_as;
        ...
        Prefrerred_profession = prefrerred_profession;
    }
    ...
    public String getPrefrerred_profession() {
        return Prefrerred_profession;
    }

    public void setPrefrerred_profession(String prefrerred_profession) {
        Prefrerred_profession = prefrerred_profession;
    }
}
