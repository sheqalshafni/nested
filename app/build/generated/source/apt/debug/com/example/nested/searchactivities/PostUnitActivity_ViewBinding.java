...
public class PostUnitActivity_ViewBinding implements Unbinder {
  private PostUnitActivity target;

  @UiThread
  public PostUnitActivity_ViewBinding(PostUnitActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public PostUnitActivity_ViewBinding(PostUnitActivity target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    PostUnitActivity target = this.target;
