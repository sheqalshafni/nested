...
public class PostRoomActivity_ViewBinding implements Unbinder {
  private PostRoomActivity target;

  @UiThread
  public PostRoomActivity_ViewBinding(PostRoomActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public PostRoomActivity_ViewBinding(PostRoomActivity target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    PostRoomActivity target = this.target;
